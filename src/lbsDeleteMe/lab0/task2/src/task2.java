package lbsDeleteMe.lab0.task2.src;
...
public class task2 {
    public static void main(String[] args) throws IOException{
        ...
        FileReader fr = new FileReader("src/lbs.lab0/task2/txtf/input.txt");
        Scanner scanner = new Scanner(fr);
        int n = scanner.nextInt();
        fr.close();

        FileWriter fw = new FileWriter("src/lbs.lab0/task2/txtf/output.txt");

package lbsDeleteMe.lab0.task3.src;
...
public class task3 {
    public static void main(String[] args) throws IOException {
        ...
        //scan number
        FileReader fr = new FileReader("src/lbs.lab0/task3/txtf/input.txt");
        ...
        FileWriter fw = new FileWriter("src/lbs.lab0/task3/txtf/output.txt");
